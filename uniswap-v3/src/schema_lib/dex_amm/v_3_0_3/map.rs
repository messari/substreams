...
use crate::pb::dex_amm::v3_0_3::{EntityCreation, PrunedTransaction};

use crate::schema_lib::dex_amm::v_3_0_3::entity_creations::{
    dex_amm_protocol::create_dex_amm_protocol_entity,
    event::{create_deposit_entity, create_swap_entity, create_withdraw_entity},
    liquidity_pool::create_liquidity_pool_entity,
    liquidity_pool_fee::create_liquidity_pool_fee_entity,
    position::create_position_entity,
    tick::create_tick_entity,
    token::create_token_entity,
};
...
pub fn map_dex_amm_v_3_0_3_entity_creation(
    ...
    match entity_creation.r#type.clone().unwrap() {
        ...
        Type::TokenEntityCreation(token_entity_creation) => {
            create_token_entity(tables, &entity_creation.entity_id, &token_entity_creation);
        }

...
pub fn create_liquidity_pool_entity(
    ...
    row.set("protocol", &liquidity_pool_entity_creation.protocol)
        .set(
            "name",
            keys::get_pool_name(
                "Uniswap V3",
                &liquidity_pool_entity_creation.input_token_symbols,
            ),
        )
        .set(
            "symbol",
            keys::get_pool_symbol(&liquidity_pool_entity_creation.input_token_symbols),
        )
        .set("inputTokens", &liquidity_pool_entity_creation.input_tokens)
        .set("fees", &liquidity_pool_entity_creation.fees)
        .set(
            "isSingleSided",
            liquidity_pool_entity_creation.is_single_sided,
        )
        ...
        .set(
            ...
            &vec![
                constants::BIGINT_ZERO.clone();
                liquidity_pool_entity_creation.input_tokens.len()
            ],
        )
        .set(
        ...
        .set(
            "inputTokenWeights",
            &liquidity_pool_entity_creation.input_token_weights,
        )
    ...
    if liquidity_pool_entity_creation.reward_tokens.len() > 0 {
        row.set(
            "rewardTokens",
            &liquidity_pool_entity_creation.reward_tokens,
        );
        row.set(
            "rewardTokenEmissionsAmount",
            &vec![
                constants::BIGINT_ZERO.clone();
                liquidity_pool_entity_creation.reward_tokens.len()
            ],
        );
        row.set(

...
pub fn create_store_operations_l1_increase_liquidity(
    ...
    store_operation_factory.track_position_mutation(keys::get_position_key(
        ...
        &increase_liquidity_event.token_id.to_string(),
    ));
}
...
pub fn prepare_increase_liquidity_entity_changes(
    ...
    entity_update_factory
        .store_operations
        .add_position_liquidity(0, &position_id, increase_liquidity_event.liquidity);
    entity_update_factory
        .store_operations
        .increment_position_deposit_count(0, &position_id);
    entity_update_factory
        .store_operations
        .add_position_cumulative_deposit_token_amounts(
            0,
            &position_id,
            vec![
                increase_liquidity_event.amount0.clone(),
                increase_liquidity_event.amount1.clone(),
            ],
        );
}

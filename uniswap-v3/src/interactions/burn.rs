...
pub fn create_store_operations_l1_burn(
    ...
    store_operation_factory
        .track_tick_mutation(keys::get_tick_key(&pool_address, &burn_event.tick_lower));
    store_operation_factory
        .track_tick_mutation(keys::get_tick_key(&pool_address, &burn_event.tick_upper));
}
...
pub fn prepare_burn_entity_changes(
    ...
    entity_update_factory
        ...
        .add_liquidity_pool_input_token_balances(
            ...
            &liquidity_pool_id,
            vec![
                burn_event.amount0.clone().neg(),
                burn_event.amount1.clone().neg(),
            ],
        );
    entity_update_factory
        .store_operations
        .add_liquidity_pool_total_liquidity(0, &liquidity_pool_id, burn_event.amount.neg());
    entity_update_factory
        .store_operations
        .increment_liquidity_pool_cumulative_withdraw_count(0, &liquidity_pool_id);

    entity_update_factory
        .store_operations
        .add_tick_liquidity_gross(0, &tick_lower_id, burn_event.amount.neg());
    entity_update_factory
        .store_operations
        .add_tick_liquidity_net(0, &tick_lower_id, burn_event.amount.neg());

    entity_update_factory
        .store_operations
        .add_tick_liquidity_gross(0, &tick_upper_id, burn_event.amount.neg());
    entity_update_factory
        .store_operations
        .add_tick_liquidity_net(0, &tick_upper_id, burn_event.amount);
}

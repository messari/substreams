...
use substreams::scalar::{self, BigDecimal, BigInt};
...
use crate::pb::dex_amm::v3_0_3::{
    DepositEntityCreation, EntityCreation, EntityUpdates, LiquidityPoolFeeEntityCreation,
    PrunedTransaction, SwapEntityCreation, TokenEntityCreation, WithdrawEntityCreation,
};
...
impl std::fmt::Display for EntityAccount {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(
            f,
            "EntityAccount {{ seen: {}, should_create: {} }}",
            self.seen, self.should_create
        )
    }
}
...
impl EntityUpdateFactory {
            ...
            if key_list[0] == "entity-mutation-count" && delta.ordinal == 0 {
                if !entity_accounting_table.contains_key(&key_list[1..].join(":")) {
                    entity_accounting_table
                        .insert(key_list[1..].join(":"), EntityAccount::new(delta.old_value));
                }
    ...
    fn get_or_create_pruned_transaction(
        &mut self,
        transaction_trace: &eth::TransactionTrace,
    ) -> &mut PrunedTransaction {
        self.pruned_transactions_map
            .entry(transaction_trace.hash.clone())
...
impl EntityUpdateFactory {
    pub fn create_dex_amm_protocol_entity_if_not_exists(
        ...
        let pruned_transaction: &mut PrunedTransaction =
            self.get_or_create_pruned_transaction(transaction_trace);
        pruned_transaction.entity_creations.push(EntityCreation {
    ...
    pub fn create_token_entity_if_not_exists(
        ...
        pruned_transaction.entity_creations.push(EntityCreation {
            entity_id: entity_id.as_bytes().to_vec(),
            r#type: Some(Type::TokenEntityCreation(TokenEntityCreation {
    ...
    pub fn create_position_entity_if_not_exists(
        ...
        pruned_transaction.entity_creations.push(EntityCreation {
            entity_id: entity_id.as_bytes().to_vec(),
            r#type: Some(Type::PositionEntityCreation(PositionEntityCreation {
    ...
    pub fn create_swap_entity(
        ...
        pruned_transaction.entity_creations.push(EntityCreation {
            ...
            r#type: Some(Type::SwapEntityCreation(SwapEntityCreation {
                pool: pool.clone(),
                protocol: protocol.clone(),
                account: account.clone(),
                input_tokens: input_tokens.clone(),
    ...
    pub fn create_deposit_entity(
        ...
        pruned_transaction.entity_creations.push(EntityCreation {
            entity_id: keys::get_event_key(hash, log_index),
            r#type: Some(Type::DepositEntityCreation(DepositEntityCreation {
                pool: pool.clone(),
                protocol: protocol.clone(),
                account: account.clone(),
                liquidity: Some(liquidity.clone().into()),
    ...
    pub fn create_withdraw_entity(
        ...
        pruned_transaction.entity_creations.push(EntityCreation {
            entity_id: keys::get_event_key(hash, log_index),
            r#type: Some(Type::WithdrawEntityCreation(WithdrawEntityCreation {
                pool: pool.clone(),
                protocol: protocol.clone(),
                account: account.clone(),
                liquidity: Some(liquidity.clone().into()),
...
impl StoreOperationFactory {
    ...
    fn track_entity_update_timestamp(&mut self, entity_type: &str, entity_id: &str) {
        if self
            .entity_updates
            .insert([entity_type, entity_id].join(":"))
        {
            self.operations.push(store_operations::set_int64(
                0,
...
impl StoreOperationFactory {
    pub fn add_raw_int64<K: AsRef<str>>(&mut self, ordinal: u64, key: K, value: i64) {
        self.operations.push(store_operations::add_int64(
            ordinal,
    ...
    pub fn set_raw_int64<K: AsRef<str>>(&mut self, ordinal: u64, key: K, value: i64) {
        self.operations.push(store_operations::set_int64(
            ordinal,
            raw_store_key(key.as_ref()),
            value,
    ...
    pub fn add_raw_bigint<K: AsRef<str>>(&mut self, ordinal: u64, key: K, value: scalar::BigInt) {
        self.operations.push(store_operations::add_bigint(
            ordinal,
            raw_store_key(key.as_ref()),
            value,
        ));
    ...
    pub fn set_raw_bigint<K: AsRef<str>>(&mut self, ordinal: u64, key: K, value: scalar::BigInt) {
        self.operations.push(store_operations::set_bigint(
            ordinal,
            raw_store_key(key.as_ref()),
            value,
        ));
    ...
    pub fn add_raw_bigdecimal<K: AsRef<str>>(
        ...
        self.operations.push(store_operations::add_bigdecimal(
            ordinal,
            raw_store_key(key.as_ref()),
            value,
        ));
    ...
    pub fn set_raw_bigdecimal<K: AsRef<str>>(
        ...
        self.operations.push(store_operations::set_bigdecimal(
            ordinal,
            raw_store_key(key.as_ref()),
            value,
        ));
    ...
    pub fn set_raw_bytes<K: AsRef<str>>(&mut self, ordinal: u64, key: K, value: Vec<u8>) {
        self.operations.push(store_operations::set_bytes(
            ordinal,
            raw_store_key(key.as_ref()),
            value,
        ));
    ...
    pub fn append_raw_bytes<K: AsRef<str>>(&mut self, ordinal: u64, key: K, value: Vec<u8>) {
        self.operations.push(store_operations::append_bytes(
            ordinal,
            raw_store_key(key.as_ref()),
            value,
        ));
    ...
    pub fn set_raw_string<K: AsRef<str>>(&mut self, ordinal: u64, key: K, value: String) {
        self.operations.push(store_operations::set_string(
            ordinal,
            raw_store_key(key.as_ref()),
            value,
        ));
    ...
    pub fn append_raw_string<K: AsRef<str>>(&mut self, ordinal: u64, key: K, value: String) {
        self.operations.push(store_operations::append_string(
            ordinal,
            raw_store_key(key.as_ref()),
            value,
        ));
...
impl StoreOperationFactory {
        ...
        for (i, v) in value.into_iter().enumerate() {
            self.operations.push(store_operations::add_bigint(
                ...
                entity_array_change_key(
                    "LiquidityPool",
                    entity_id.as_ref(),
                    "cumulativeSupplySideRevenueTokenAmounts",
                    i,
                    array_size,
                ),
                v.clone(),
        ...
        for (i, v) in value.into_iter().enumerate() {
            self.operations.push(store_operations::add_bigint(
                ...
                entity_array_change_key(
                    "LiquidityPool",
                    entity_id.as_ref(),
                    "cumulativeProtocolSideRevenueTokenAmounts",
                    i,
                    array_size,
                ),
                v.clone(),
        ...
        for (i, v) in value.into_iter().enumerate() {
            self.operations.push(store_operations::add_bigint(
                ...
                entity_array_change_key(
                    "LiquidityPool",
                    entity_id.as_ref(),
                    "cumulativeTotalRevenueTokenAmounts",
                    i,
                    array_size,
                ),
                v.clone(),
    ...
    pub fn increment_position_deposit_count<K: AsRef<str>>(&mut self, ordinal: u64, entity_id: K) {
    ...
    pub fn increment_position_withdraw_count<K: AsRef<str>>(&mut self, ordinal: u64, entity_id: K) {
        self.track_entity_update_timestamp("Position", entity_id.as_ref());
        self.operations.push(store_operations::add_int64(
            ordinal,
    ...
    pub fn track_dex_amm_protocol_mutation<K: AsRef<str>>(&mut self, entity_id: K) {
        self.operations.push(store_operations::add_int64(
            0,
    ...
    pub fn track_liquidity_pool_mutation<K: AsRef<str>>(&mut self, entity_id: K) {
        self.operations.push(store_operations::add_int64(
            0,
    ...
    pub fn track_liquidity_pool_fee_mutation<K: AsRef<str>>(&mut self, entity_id: K) {
        self.operations.push(store_operations::add_int64(
            0,
    ...
    pub fn track_position_mutation<K: AsRef<str>>(&mut self, entity_id: K) {
        self.operations.push(store_operations::add_int64(
            0,
    ...
    pub fn track_tick_mutation<K: AsRef<str>>(&mut self, entity_id: K) {
        self.operations.push(store_operations::add_int64(
            0,
    ...
    pub fn track_token_mutation<K: AsRef<str>>(&mut self, entity_id: K) {
        self.operations.push(store_operations::add_int64(
            0,

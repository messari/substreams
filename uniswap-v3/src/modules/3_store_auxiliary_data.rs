                ...
                match data_source.data_source_type {
                    0 => {
                        for log in &call_view.call.logs {
                            if let Some(mint_event) =
                                PoolContract::events::Mint::match_and_decode(&log)
                            {
                                interactions::mint::create_store_operations_l1_mint(
                                    &mut store_operation_factory,
                                    mint_event,
                                    call_view.call,
                                );
                            ...
                            {
                                interactions::burn::create_store_operations_l1_burn(
                                    &mut store_operation_factory,
                                    burn_event,
                                    call_view.call,
                                );
                    ...
                    1 => {
                        for log in &call_view.call.logs {
                            ...
                            {
                                interactions::pool_created::create_store_operations_l1_pool_created(
                                    &mut store_operation_factory,
                                    pool_created_event,
                                );
                            }
...
#[substreams::handlers::store]
pub fn add_bigint_l1(store_operations: StoreOperations, add_bigint_store: store::StoreAddBigInt) {
    for store_operation in store_operations.operations {
        match store_operation.r#type.unwrap() {
...
#[substreams::handlers::store]
pub fn add_int64_l1(store_operations: StoreOperations, add_int64_store: store::StoreAddInt64) {
    for store_operation in store_operations.operations {
        match store_operation.r#type.unwrap() {
...
#[substreams::handlers::store]
pub fn set_bigint_l1(store_operations: StoreOperations, set_bigint_store: store::StoreSetBigInt) {
    for store_operation in store_operations.operations {
        match store_operation.r#type.unwrap() {
...
#[substreams::handlers::store]
pub fn set_bytes_l1(store_operations: StoreOperations, set_bytes_store: store::StoreSetRaw) {
    for store_operation in store_operations.operations {
        match store_operation.r#type.unwrap() {

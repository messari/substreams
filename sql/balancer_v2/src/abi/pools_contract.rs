    ...
    pub mod functions {
        ...
        pub struct DelegateProtocolSwapFeesSentinel {}
        impl DelegateProtocolSwapFeesSentinel {
            const METHOD_ID: [u8; 4] = [221u8, 244u8, 98u8, 123u8];
            pub fn decode(
        ...
        impl substreams_ethereum::Function for DelegateProtocolSwapFeesSentinel {
            const NAME: &'static str = "DELEGATE_PROTOCOL_SWAP_FEES_SENTINEL";
        ...
        for DelegateProtocolSwapFeesSentinel {
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetActualSupply {}
        impl GetActualSupply {
            const METHOD_ID: [u8; 4] = [135u8, 111u8, 48u8, 59u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for GetActualSupply {
            const NAME: &'static str = "getActualSupply";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl GetAmplificationParameter {
            const METHOD_ID: [u8; 4] = [109u8, 172u8, 207u8, 250u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
            ...
            pub fn output_call(
                ...
                (substreams::scalar::BigInt, bool, substreams::scalar::BigInt),
                String,
            > {
                Self::output(call.return_data.as_ref())
            }
            ...
            pub fn call(
                &self,
                address: Vec<u8>,
            ) -> Option<(substreams::scalar::BigInt, bool, substreams::scalar::BigInt)> {
                use substreams_ethereum::pb::eth::rpc;
                let rpc_calls = rpc::RpcCalls {
                    calls: vec![
                        rpc::RpcCall { to_addr : address, data : self.encode(), }
        ...
        impl substreams_ethereum::Function for GetAmplificationParameter {
            const NAME: &'static str = "getAmplificationParameter";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetBptIndex {}
        impl GetBptIndex {
            const METHOD_ID: [u8; 4] = [130u8, 104u8, 122u8, 86u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for GetBptIndex {
            const NAME: &'static str = "getBptIndex";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl GetLastJoinExitData {
            const METHOD_ID: [u8; 4] = [60u8, 151u8, 93u8, 81u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for GetLastJoinExitData {
            const NAME: &'static str = "getLastJoinExitData";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetMinimumBpt {}
        impl GetMinimumBpt {
            const METHOD_ID: [u8; 4] = [4u8, 132u8, 45u8, 76u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for GetMinimumBpt {
            const NAME: &'static str = "getMinimumBpt";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetProtocolFeePercentageCache {
            pub fee_type: substreams::scalar::BigInt,
        }
        impl GetProtocolFeePercentageCache {
            const METHOD_ID: [u8; 4] = [112u8, 70u8, 64u8, 22u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.fee_type.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
        ...
        impl substreams_ethereum::Function for GetProtocolFeePercentageCache {
            const NAME: &'static str = "getProtocolFeePercentageCache";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt>
        for GetProtocolFeePercentageCache {
            fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
                Self::output(data)
            }
        }
        ...
        for GetProtocolFeesCollector {
            fn output(data: &[u8]) -> Result<Vec<u8>, String> {
                Self::output(data)
            }
        }
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetProtocolSwapFeeDelegation {}
        impl GetProtocolSwapFeeDelegation {
            const METHOD_ID: [u8; 4] = [21u8, 176u8, 1u8, 91u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for GetProtocolSwapFeeDelegation {
            const NAME: &'static str = "getProtocolSwapFeeDelegation";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        for GetProtocolSwapFeeDelegation {
            fn output(data: &[u8]) -> Result<bool, String> {
                Self::output(data)
            }
        }
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetRateProviders {}
        impl GetRateProviders {
            const METHOD_ID: [u8; 4] = [35u8, 138u8, 45u8, 89u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for GetRateProviders {
            const NAME: &'static str = "getRateProviders";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<Vec<Vec<u8>>> for GetRateProviders {
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetTokenRate {
            pub token: Vec<u8>,
        }
        impl GetTokenRate {
            const METHOD_ID: [u8; 4] = [84u8, 222u8, 160u8, 10u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for GetTokenRate {
            const NAME: &'static str = "getTokenRate";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetTokenRateCache {
            pub token: Vec<u8>,
        }
        impl GetTokenRateCache {
            const METHOD_ID: [u8; 4] = [127u8, 18u8, 96u8, 209u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for GetTokenRateCache {
            const NAME: &'static str = "getTokenRateCache";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct IsExemptFromYieldProtocolFee {}
        impl IsExemptFromYieldProtocolFee {
            const METHOD_ID: [u8; 4] = [119u8, 21u8, 27u8, 238u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for IsExemptFromYieldProtocolFee {
            const NAME: &'static str = "isExemptFromYieldProtocolFee";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<bool>
        for IsExemptFromYieldProtocolFee {
            fn output(data: &[u8]) -> Result<bool, String> {
                Self::output(data)
            }
        }
        ...
        impl IsTokenExemptFromYieldProtocolFee {
            const METHOD_ID: [u8; 4] = [171u8, 119u8, 89u8, 241u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for IsTokenExemptFromYieldProtocolFee {
            const NAME: &'static str = "isTokenExemptFromYieldProtocolFee";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<bool>
        for IsTokenExemptFromYieldProtocolFee {
            fn output(data: &[u8]) -> Result<bool, String> {
                Self::output(data)
            }
        }
                    ...
                    &[
                        ethabi::Token::Tuple(
                            vec![
                                ...
                                .swap_request.0.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                panic!("negative numbers are not supported") }, }
                                ...
                                .swap_request.2)),
                                ethabi::Token::Uint(ethabi::Uint::from_big_endian(match self
                                .swap_request.3.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                panic!("negative numbers are not supported") }, }
                                .as_slice(),),), ethabi::Token::FixedBytes(self.swap_request
                                .4.as_ref().to_vec()),
                                ethabi::Token::Uint(ethabi::Uint::from_big_endian(match self
                                .swap_request.5.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                panic!("negative numbers are not supported") }, }
                                ...
                                .swap_request.6)),
                                ethabi::Token::Address(ethabi::Address::from_slice(& self
                                .swap_request.7)), ethabi::Token::Bytes(self.swap_request.8
                                .clone())
                            ],
                        ),
                        {
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct SetTokenRateCacheDuration {
            pub token: Vec<u8>,
            pub duration: substreams::scalar::BigInt,
        }
        impl SetTokenRateCacheDuration {
            const METHOD_ID: [u8; 4] = [244u8, 183u8, 150u8, 77u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for SetTokenRateCacheDuration {
            const NAME: &'static str = "setTokenRateCacheDuration";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        pub struct StartAmplificationParameterUpdate {
            pub raw_end_value: substreams::scalar::BigInt,
            pub end_time: substreams::scalar::BigInt,
        }
        impl StartAmplificationParameterUpdate {
            const METHOD_ID: [u8; 4] = [47u8, 26u8, 11u8, 201u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.raw_end_value.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
                        ...
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.end_time.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
        ...
        impl substreams_ethereum::Function for StartAmplificationParameterUpdate {
            const NAME: &'static str = "startAmplificationParameterUpdate";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct StopAmplificationParameterUpdate {}
        impl StopAmplificationParameterUpdate {
            const METHOD_ID: [u8; 4] = [235u8, 15u8, 36u8, 214u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for StopAmplificationParameterUpdate {
            const NAME: &'static str = "stopAmplificationParameterUpdate";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct UpdateProtocolFeePercentageCache {}
        impl UpdateProtocolFeePercentageCache {
            const METHOD_ID: [u8; 4] = [13u8, 160u8, 102u8, 156u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for UpdateProtocolFeePercentageCache {
            const NAME: &'static str = "updateProtocolFeePercentageCache";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct UpdateTokenRateCache {
            pub token: Vec<u8>,
        }
        impl UpdateTokenRateCache {
            const METHOD_ID: [u8; 4] = [45u8, 242u8, 199u8, 192u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for UpdateTokenRateCache {
            const NAME: &'static str = "updateTokenRateCache";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
    ...
    pub mod events {
        ...
        pub struct AmpUpdateStarted {
            pub start_value: substreams::scalar::BigInt,
            pub end_value: substreams::scalar::BigInt,
            pub start_time: substreams::scalar::BigInt,
            pub end_time: substreams::scalar::BigInt,
        }
        impl AmpUpdateStarted {
        ...
        impl substreams_ethereum::Event for AmpUpdateStarted {
            const NAME: &'static str = "AmpUpdateStarted";
        ...
        pub struct AmpUpdateStopped {
            pub current_value: substreams::scalar::BigInt,
        }
        impl AmpUpdateStopped {
            const TOPIC_ID: [u8; 32] = [
                160u8,
                208u8,
                21u8,
        ...
        impl substreams_ethereum::Event for AmpUpdateStopped {
            const NAME: &'static str = "AmpUpdateStopped";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        pub struct ProtocolFeePercentageCacheUpdated {
            pub fee_type: substreams::scalar::BigInt,
            pub protocol_fee_percentage: substreams::scalar::BigInt,
        }
                ...
                Ok(Self {
                    token_index: {
                        ...
                        ethabi::decode(
                            ...
                            .map_err(|e| {
                                format!(
                                    "unable to decode param 'token_index' from topic of type 'uint256': {:?}",
                                    e
                                )
                            })?
                            .pop()
        ...
        impl substreams_ethereum::Event for TokenRateCacheUpdated {
            const NAME: &'static str = "TokenRateCacheUpdated";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        pub struct TokenRateProviderSet {
            pub token_index: substreams::scalar::BigInt,
            pub provider: Vec<u8>,
            pub cache_duration: substreams::scalar::BigInt,
        }
        impl TokenRateProviderSet {
            const TOPIC_ID: [u8; 32] = [
                221u8,
                109u8,
                28u8,
        ...
        impl substreams_ethereum::Event for TokenRateProviderSet {
            const NAME: &'static str = "TokenRateProviderSet";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
